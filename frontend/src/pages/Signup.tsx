    ...
    return (
        <Card className="w-100">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid w-full items-center gap-4">
                        ...
                        <div className="flex flex-col space-y-1.5">
                            ...
                            <Input required id="name" placeholder="Digite nome completo" type="text"
                            value={username}
                        ...
                        <div className="flex flex-col space-y-1.5">
                            ...
                            <Input required id="email" placeholder="Digite email" type="email" 
                            value={email}
                        ...
                        <div className="flex flex-col space-y-1.5">
                            ...
                            <Input className="pr-10" required id="senha" placeholder="Digite senha" type={verSenha ? "text" : "password"} 
                                value={password}
            ...
            <CardFooter className="flex flex-col w-full gap-4">
                <Button className="w-full bg-[#223A60] hover:bg-[#2F4A80] text-white transition-colors" onClick={() => alert("Usuário cadastrado com sucesso!")}>Criar uma conta</Button>
